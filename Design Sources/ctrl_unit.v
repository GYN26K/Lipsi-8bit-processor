module ctrl_unit(
    ...
    output reg [1:0] mux_pc_rd,      // selection for PC read
    ...
    output reg [3:0] next_state     // Next statel
);
...
begin
    case(state)
        // State S0 logic
        // S0  : Instruction Decode State
        // Decodes instruction opcode
        // Selects ALU operation
        // Decides next FSM state
        ...
        //     S1  : ALU Register Instruction Execute
        //   Writes ALU result into accumulator
        //   Increments PC
        ...
        //   S2  : Store Instruction Complete
        //   Stores accumulator value into register
        //   Increments PC
        //   Fetches next instruction
        S2: begin
            mux_pc_rd = 2'b00;
        ...
        // S3  : Branch and Link Complete
        //       Saves PC into register
        //       Updates PC       
        S3: begin
            mux_pc_rd = 2'b01;
            wr_addr = 0;
    ...
    //     S4  : Indirect Load Start
    //   Reads memory address from register
        S4: begin
            mux_pc_rd = 2'b01;
            wr_addr = 0;
            pc_en = 0; 
...
S5  : Indirect Load Complete
      Loads memory data into accumulator
      Increments PC

S6  : Indirect Store Start
      Reads indirect memory address

S7  : Indirect Store Complete
      Stores accumulator into memory
      Increments PC

S8  : Immediate ALU Instruction Complete
      Executes ALU immediate operation
      Writes result into accumulator
      Increments PC

S9  : Branch Taken
      Loads branch target into PC

S10 : Branch Not Taken
      Continues normal sequential execution

S11 : Halt State
      Processor stops permanently
